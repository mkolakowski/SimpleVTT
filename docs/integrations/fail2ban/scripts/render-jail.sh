...
VARS='FAIL2BAN_LOGIN_MAXRETRY FAIL2BAN_LOGIN_FINDTIME FAIL2BAN_LOGIN_BANTIME FAIL2BAN_MAGIC_LINK_REPLAY_BANTIME FAIL2BAN_API_PROBE_MAXRETRY FAIL2BAN_DEFAULT_BANTIME FAIL2BAN_AUDIT_LOG_PATH FAIL2BAN_ACTION FAIL2BAN_SCANNER_MAXRETRY FAIL2BAN_SCANNER_FINDTIME FAIL2BAN_SCANNER_BANTIME FAIL2BAN_FLOOD_ENABLED FAIL2BAN_FLOOD_MAXRETRY FAIL2BAN_FLOOD_FINDTIME FAIL2BAN_FLOOD_BANTIME FAIL2BAN_IGNOREIP CLOUDFLARE_API_TOKEN CLOUDFLARE_ZONE_ID CLOUDFLARE_API_BASE_URL FAIL2BAN_DISCORD_WEBHOOK_URL FAIL2BAN_DISCORD_USERNAME'
