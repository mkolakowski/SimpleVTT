...
| 2 | Fighting Style | 🟢 | Same framework as the Fighter row above. v2.99.83/85/87 wired Archery / Dueling / Great Weapon Fighting / Two-Weapon Fighting auto-applies; Protection lives on the v2.68.10 reactions panel; Defense (+1 AC) filed pending the auto-AC engine. Caelan demo (currently `fighting_style: "protection"`); a PATCH to any other style routes through the same helpers. |
| 2 | Spellcasting | ✅ | |
