...
- Lucky (multi-trigger), War Caster (extends OA framework), Mage Slayer (adds `spell_cast_near` listener), Defensive Duelist. ✅ Defensive Duelist partial — v2.74.0 wires the feat through the v2.69.0 attack_targeted trigger; PB +3 AC bump dispatch + Lyra demo fixture + live tests. Lucky/WC/MS still ⚪.
