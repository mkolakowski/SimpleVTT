...
**Authors:** rolling
**Last updated:** 2026-06-12 (Phase 4 in progress — first complex-spell deep-dive shipped: Counterspell prompt-emission contract, `tests/harness/test_cast_counterspell.py`)
