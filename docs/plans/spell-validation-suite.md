...
**Authors:** rolling
**Last updated:** 2026-06-12 (Phase 4 in progress — five complex-spell deep-dives shipped: Counterspell `test_cast_counterspell.py`, Spirit Guardians `test_cast_spirit_guardians.py`, Eldritch Blast `test_cast_eldritch_blast.py`, Magic Missile `test_cast_magic_missile.py`, Spiritual Weapon `test_cast_spiritual_weapon.py`)
