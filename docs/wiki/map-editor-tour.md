...
| **Environment → Fog** | Fog | Fog of war. Toggle it on, then paint **revealed** rectangles over the areas the party can see; the rest stays hidden. | Goblin Warrens, Tide-Wracked Catacombs, Drowned Reef, Shadowfell Spire (all revealed generously so the play area stays visible) |
