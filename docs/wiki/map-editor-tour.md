...
| **Environment → Terrain** | Terrain | A region tagged difficult / water / lava / ice / swamp / rubble — the tabletop shades it so players see the hazard. Drag a rectangle on any map; on a **gridless** map you can instead **click four dots** to place a free-form quad, and Resize drags each corner independently. | Tide-Wracked Catacombs (standing water); Caldera Throne (lava); Drowned Reef (the kelp forest is a free-form quad) |
