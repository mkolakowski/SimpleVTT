...
| [Vision & light (sight/obscurement engine)](../plans/vision-and-light.md) | Markdown (design) | Contributors | 🟢 Phases 0–4 shipped (v2.704.0–v2.709.0 · full server engine); Phase 5 (client lighting) queued |
