...
| [Race features (close the SRD races gap)](../plans/race-features.md) | Markdown (design) | Contributors | ⚪ proposed (v2.393.0) — closes the SRD Races row from ~90% → ~100% via 7 phase ships (Savage Attacks / Infernal Legacy / Stonecunning / heavy-armor speed / Halfling Nimbleness + Naturally Stealthy / Artificer's Lore) on top of v2.392.0 Breath Weapon |
