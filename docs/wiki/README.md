...
| [Fork & tweak SRD mechanics as homebrew](../plans/homebrew-fork-srd.md) | Markdown (design) | Contributors | 🟠 Phases 1–2 shipped (v2.569.0–v2.571.0 · fork/edit endpoints + Workshop UI; Phase 3 pickers pending) |
