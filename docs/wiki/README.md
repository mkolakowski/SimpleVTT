...
| [Legendary actions + lair actions](../plans/legendary-actions.md) | Markdown (design) | Contributors | 🟠 Phases 1a + 1b shipped (v2.159.33–.34) — cost-integer backfill + budget gate + /use_legendary_action endpoint + turn-start refresh; Phase 1c damage-dispatch chaining + Phases 2–3 pending |
