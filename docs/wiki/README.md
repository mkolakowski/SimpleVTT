...
| [Legendary actions + lair actions](../plans/legendary-actions.md) | Markdown (design) | Contributors | 🟠 Phase 1a shipped (v2.159.33) — 39 cost integers backfilled across 30 monsters; Phase 1b dispatch + Phases 2–3 pending |
