...
| [Fork & tweak SRD mechanics as homebrew](../plans/homebrew-fork-srd.md) | Markdown (design) | Contributors | 🟠 Phases 1 + 2a shipped (v2.569.0–v2.570.0 · fork/revert/edit endpoints; UI pending) |
