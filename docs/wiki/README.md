...
| [App-wide roles + GM/player caps + storage accounting & limits](../plans/app-wide-roles-and-storage.md) | Markdown (design) | Contributors | 🟠 Arc A shipped (v2.584.0–v2.587.0 · roles + caps + assignment); Arc B (storage) pending |
