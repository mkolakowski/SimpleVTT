...
| [Pending-resolution state machine](../plans/pending-resolution-state-machine.md) | Markdown (design) | Contributors | 🟠 Phases 0–3a shipped (save-failure resolver extracted v2.610.2; Silvery Barbs re-resolves condition v2.611.0 + save-for-half→full v2.612.0); only attack hit↔miss re-resolution remains |
...
| [Cast-and-broadcast utility-spell tail](../plans/cast-and-broadcast-tail.md) | Markdown (design) | Contributors | 🟢 Phase 1 closed (v2.441.0); Phase 2 in progress — #67 shipped (Forbiddance, v2.553.0); Bucket B filed as permanently GM-narrated |
