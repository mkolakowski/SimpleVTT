...
|------|--------|----------|--------|
| [Notes & handouts (GM prep + E2E-encrypted player notes)](../plans/notes-and-handouts.md) | Markdown (design) | Contributors | 🟠 Phases 1–2 shipped (v2.554.0–v2.555.0); Phases 3–5 pending |
