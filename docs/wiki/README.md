...
|------|--------|----------|--------|
| [Notes & handouts (GM prep + E2E-encrypted player notes)](../plans/notes-and-handouts.md) | Markdown (design) | Contributors | 🟠 Phases 1–4 shipped (v2.554.0–v2.558.0); Phase 5 (Notes drawer UI) pending |
