...
| [Vision & light (sight/obscurement engine)](../plans/vision-and-light.md) | Markdown (design) | Contributors | 🟠 Phases 0–1 shipped (v2.704.0–v2.705.0 · data model + resolver); Phase 2 (/attack) next |
