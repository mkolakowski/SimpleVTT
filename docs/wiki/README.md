...
| [Race features (close the SRD races gap)](../plans/race-features.md) | Markdown (design) | Contributors | 🟢 partial (v2.396.0) — Phases 1+2 shipped (v2.395.0 Tiefling racial Hellish Rebuke + v2.396.0 Hill Dwarf Stonecunning); plus pre-existing Savage Attacks (v2.99.23, reconciled v2.394.0). 4 phase ships remaining (heavy-armor speed / Halfling Nimbleness + Naturally Stealthy / Artificer's Lore) |
