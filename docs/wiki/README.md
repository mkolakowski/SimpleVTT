...
| [Ability-score override engine](../plans/str-override.md) | Markdown (design) | Contributors | ⚪ proposed (v2.211.0) — substrate for Belt of Giant Strength + Amulet of Health + Potion of Giant Strength; composes with carry-capacity STR reader |
