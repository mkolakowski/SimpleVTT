...
| [Race features (close the SRD races gap)](../plans/race-features.md) | Markdown (design) | Contributors | 🟢 partial (v2.394.0) — Phase 1 (Savage Attacks) reconciled as already shipped v2.99.23; 6 phase ships remaining (Infernal Legacy / Stonecunning / heavy-armor speed / Halfling Nimbleness + Naturally Stealthy / Artificer's Lore) on top of v2.392.0 Breath Weapon |
