...
`app/static/demo/maps/goblin-warrens.png`
...
`app/static/demo/maps/tide-wracked-catacombs.png`
...
`app/static/demo/maps/drowned-reef.png`
...
`app/static/demo/maps/shadowfell-spire.png`
...
`app/static/demo/maps/caldera-throne.png`
...
`app/static/demo/tokens/rogue.jpg`
...
`app/static/demo/tokens/wizard.jpg`
...
`app/static/demo/tokens/cleric.jpg`
...
`app/static/demo/tokens/bandit-captain.jpg`
...
`app/static/demo/tokens/goblin-captain.jpg`
...
`app/static/demo/tokens/thug.jpg`
...
`app/static/demo/tokens/bandit-alpha.jpg`
...
`app/static/demo/tokens/bandit-beta.jpg`
...
`app/static/demo/tokens/bandit-gamma.jpg`
...
`app/static/demo/maps/tavern.png`
