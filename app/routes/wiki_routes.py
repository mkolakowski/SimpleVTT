...
_DOC_ALLOWLIST: dict[str, Path] = {
    ...
    "plan-thiefs-reflexes": Path("docs") / "plans" / "thiefs-reflexes.md",
    ...
    "plan-exploration-fog": Path("docs") / "plans" / "exploration-fog.md",
    ...
    "plan-admin-center-mfa": Path("docs") / "plans" / "admin-center-mfa.md",
    ...
    "plan-spell-utility-upcast": Path("docs") / "plans" / "spell-utility-upcast.md",
    ...
    "plan-campaign-stats": Path("docs") / "plans" / "campaign-stats.md",
    ...
    "plan-backup-export-overhaul": Path("docs") / "plans" / "backup-export-overhaul.md",
    "plan-editor-controls-reorg": Path("docs") / "plans" / "editor-controls-reorg.md",
}
