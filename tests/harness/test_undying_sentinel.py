...
HP-mutation hook into /apply_damage is filed as a follow-up.
The endpoint decrements an `undying-sentinel` resource (max 1,
auto-bootstrapped if missing, refilled by long rest).
